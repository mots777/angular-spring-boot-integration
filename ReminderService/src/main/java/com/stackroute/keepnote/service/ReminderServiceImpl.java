...
public class ReminderServiceImpl implements ReminderService {
	...
	public Reminder createReminder(Reminder reminder) throws ReminderNotCreatedException {
		...
		final Reminder createdReminder = this.reminderRepository.insert(reminder);
	...
	public boolean deleteReminder(String reminderId) throws ReminderNotFoundException {
		...
		final Optional<Reminder> reminder = this.reminderRepository.findById(reminderId);
		if(null == reminder) {
			throw new ReminderNotFoundException("Reminder Does Note Exists Exception");
		}
	...
	public Reminder updateReminder(Reminder reminder, String reminderId) throws ReminderNotFoundException {
		...
		try {			
			...
			updatedReminder = getReminderById(reminderId);
	...
	public Reminder getReminderById(String reminderId) throws ReminderNotFoundException {
		...
		try {
			final Optional<Reminder> reminderOpt = this.reminderRepository.findById(reminderId);
			if(null == reminderOpt) {
